"""
Django settings for projsettings project.
...
SECRET_KEY = 'django-insecure-uti)2sj($3f9czdt^vxi6msm-esq1w8(2zk_c-8(zpan07=f^e'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1','mohitsatija.herokuapp.com']
...
ROOT_URLCONF = 'projsettings.urls'
...
WSGI_APPLICATION = 'projsettings.wsgi.application'
